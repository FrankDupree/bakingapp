...
import static android.codeniro.com.bakingapp.widgets.UpdateService.FROM_ACTIVITY_INGREDIENTS_LIST;

/**
 * Created by Dupree on 23/06/2017.
 */

public class WidgetBakingProvider extends AppWidgetProvider {
    ...
    public void onReceive(Context context, Intent intent) {
        ...
        int[] appWidgetIds = appWidgetManager.getAppWidgetIds(new ComponentName(context, WidgetBakingProvider.class));
        ...
        if (action.equals("android.appwidget.action.APPWIDGET_UPDATE2")) {
            ...
            WidgetBakingProvider.updateBakingWidgets(context, appWidgetManager, appWidgetIds);
